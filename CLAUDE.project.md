...
- El orquestador puede proponer e implementar páginas y funcionalidades adicionales que mejoren la experiencia sin aprobación del usuario, siempre que no rompan lo ya definido
...
| Composite | Widgets en `presentation/common/widgets` | Composición reutilizable de UI |
